            ...
            <div className="mt-1 flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 mt-[2.5px] sm:block">
                    <div className="flex space-x-4">
                        ...
                        <NavLink to="/" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About</NavLink>

                        <NavLink to="/" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Services</NavLink>

                        <NavLink to="/" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Safety</NavLink>

                        <NavLink to="/" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Help</NavLink>
                        ...
                        <NavLink to="/" className="bg-white text-black px-3 ml-[30px] py-2 rounded-md text-sm font-medium" aria-current="page">Login</NavLink>

                        <NavLink to="/" className="text-gray-300 hover:bg-white hover:text-black px-3 py-2 rounded-md text-sm font-medium">Sign up</NavLink>

                    </div>
                </div>
            </div>
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                {/* <div className="hidden sm:ml-6 sm:block md:my-3 mobileMenu">
                    <NavLink to="/" className="bg-white text-black mx-2 px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Login</NavLink>

                    <NavLink to="/" className="text-gray-300 hover:bg-white mx-2 hover:text-black px-3 py-2 rounded-md text-sm font-medium">Sign up</NavLink>
                </div> */}
                    {/* <!-- Profile dropdown --> */}
